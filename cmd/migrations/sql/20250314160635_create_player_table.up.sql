...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Deportivo Villa del Mar'), 'David', 'Wilson', 'GBR', 'defender', 30, 3600000, 94000, 74, 77, 73, 0, false, 82, 84, 87),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Agrupación Deportiva Puente Largo'), 'Liam', 'Evans', 'GBR', 'midfielder', 28, 3200000, 89000, 71, 73, 70, 0, false, 79, 81, 84),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Sporting Monteluz CF'), 'Erik', 'Larsen', 'DNK', 'defender', 30, 3500000, 94000, 74, 76, 73, 0, false, 82, 84, 87),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Sporting Monteluz CF'), 'Nicolás', 'Gómez', 'URY', 'midfielder', 28, 3300000, 90000, 72, 74, 71, 0, false, 80, 82, 85),
...
(gen_random_uuid(), (SELECT id FROM oft.team WHERE name = 'Sporting Monteluz CF'), 'James', 'Wilson', 'GBR', 'forward', 29, 3400000, 92000, 73, 75, 72, 0, false, 81, 83, 86),
